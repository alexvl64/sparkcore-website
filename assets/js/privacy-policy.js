...
const ppTranslations = {
  fr: {
    ...
    pp1Reg: "SparkCore.investment OÜ est enregistrée en tant que gestionnaire de fonds d'investissement alternatif de petite taille auprès de l'Autorité de surveillance financière estonienne (Finantsinspektsioon) et détient une licence d'Institution Financière délivrée par l'Unité de renseignement financier estonienne (FIU). Enregistrement : <a href='https://www.fi.ee/en/investment-market/fund-management-companies-0/investment-market/small-fund-managers-without-activity-licence/sparkcoreinvestment-ou' target='_blank' rel='noopener noreferrer'>Registre EFSA</a>.",
  ...
  en: {
    ...
    pp1Reg: "SparkCore.investment OÜ is registered as a small alternative investment fund manager with the Estonian Financial Supervision Authority (Finantsinspektsioon) and holds a Financial Institution licence issued by the Estonian Financial Intelligence Unit (FIU). Registration: <a href='https://www.fi.ee/en/investment-market/fund-management-companies-0/investment-market/small-fund-managers-without-activity-licence/sparkcoreinvestment-ou' target='_blank' rel='noopener noreferrer'>EFSA register</a>.",
