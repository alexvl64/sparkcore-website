const translations = {
  fr: {
    ...
    investEyebrow: "Investir",
    investText: "Nos fonds sont commercialisés auprès d'investisseurs professionnels. D'autres investisseurs peuvent, sous conditions, y accéder dans les limites du régime estonien.",
    investCall: "Planifier un appel",
    investTermsTitle: "Conditions clés",
    investStepsTitle: "Devenir investisseur",
    investTermMinLabel: "Investissement minimum",
    investTermMin: "50 000 €",
    investTermCcyLabel: "Devises",
    investTermCcy: "EUR, USD, stablecoins réglementés",
    investTermNavLabel: "Valorisation",
    investTermNav: "VL quotidienne",
    investTermLiqLabel: "Liquidité",
    investTermLiq: "Rachats trimestriels",
  ...
  en: {
    ...
    investEyebrow: "Investing",
    investText: "SparkCore funds are marketed to professional investors. Other investors may, subject to conditions, access them within the limits of the Estonian regime.",
    investCall: "Schedule a call",
    investTermsTitle: "Key terms",
    investStepsTitle: "How to become an investor",
    investTermMinLabel: "Minimum investment",
    investTermMin: "€50,000",
    investTermCcyLabel: "Currencies",
    investTermCcy: "EUR, USD, regulated stablecoins",
    investTermNavLabel: "Valuation",
    investTermNav: "Daily NAV",
    investTermLiqLabel: "Liquidity",
    investTermLiq: "Quarterly redemptions",
